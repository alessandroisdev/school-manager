        ...
        <div class="row">
                    ...
                    <form action="{{ route('finance.accounts.store') }}" method="POST">
                        ...
                        <div class="mt-4 text-end">
                            <button type="submit" class="btn btn-primary fw-bold px-4 shadow-sm"><i
                                    class="bi bi-check-lg me-1"></i> Salvar Conta</button>
                        </div>
                    </form>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="glass-card p-4 bg-primary bg-opacity-10 border-0 h-100">
                    ...
                    <p class="text-muted small">As contas bancárias cadastradas aqui são utilizadas pelo
                        <strong>OpenBoleto</strong> para gerar os boletos e carnês dos seus alunos.</p>
                    <p class="text-muted small mb-0">Preencha corretamente o código do banco, a agência e a conta. As
                        instruções de multa e juros também podem ser personalizadas.</p>
                </div>
            </div>
        </div>
    </div>
