<x-app-layout>
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="h3 mb-0 text-dark fw-bold">Nova Turma</h2>
        ...
        <div class="glass-card p-4 p-md-5 mx-auto" style="max-width: 800px;">
            <form action="{{ route('academic.classes.store') }}" method="POST">
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-8">
                        <label for="name" class="form-label fw-bold text-muted">Nome da Turma (Ex: 1º Ano A)</label>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="capacity" id="capacity" class="form-control form-control-lg bg-light border-0 @error('capacity') is-invalid @enderror" value="{{ old('capacity', 30) }}" min="1" max="100" required>
                        @error('capacity')
                            <div class="invalid-feedback fw-bold">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="d-grid mt-5">
                    <button type="submit" class="btn btn-primary btn-lg fw-bold shadow-sm">
                        <i class="bi bi-check2-circle me-1"></i> Salvar Turma
                    </button>
                </div>
            </form>
        </div>
