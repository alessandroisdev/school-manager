<x-app-layout>
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="h3 mb-0 text-dark fw-bold">Editar Disciplina</h2>
            ...
            <form action="{{ route('academic.subjects.update', $subject) }}" method="POST">
                ...
                <div class="row g-4">
                    <div class="col-md-8">
                        ...
                        <input type="text" name="name" id="name" class="form-control form-control-lg bg-light border-0 @error('name') is-invalid @enderror" value="{{ old('name', $subject->name) }}" required autofocus>
                        @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>

                    <div class="col-md-4">
                        <label for="code" class="form-label fw-bold text-muted small">Código Interno</label>
                        <input type="text" name="code" id="code" class="form-control form-control-lg bg-light border-0 @error('code') is-invalid @enderror" value="{{ old('code', $subject->code) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" name="workload" id="workload" class="form-control bg-light border-0 @error('workload') is-invalid @enderror" value="{{ old('workload', $subject->workload) }}" min="1">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="is_active" id="is_active" class="form-select bg-light border-0 @error('is_active') is-invalid @enderror">
                            <option value="1" {{ old('is_active', $subject->is_active) == '1' ? 'selected' : '' }}>Ativa</option>
                            <option value="0" {{ old('is_active', $subject->is_active) == '0' ? 'selected' : '' }}>Inativa</option>
                        </select>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="description" id="description" rows="3" class="form-control bg-light border-0 @error('description') is-invalid @enderror">{{ old('description', $subject->description) }}</textarea>
                ...
                <div class="text-end">
                    <button type="submit" class="btn btn-primary fw-bold shadow-sm px-4">
                        <i class="bi bi-check-lg me-2"></i> Atualizar Disciplina
                    </button>
                </div>
            </form>
        </div>
