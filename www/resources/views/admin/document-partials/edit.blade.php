                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        <div class="form-check form-switch mb-2">
                            <input class="form-check-input" type="checkbox" role="switch" id="isActive" name="is_active" value="1" {{ $documentPartial->is_active ? 'checked' : '' }}>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="content" id="html-editor" class="form-control">{{ $documentPartial->content }}</textarea>
                    </div>
                </div>
