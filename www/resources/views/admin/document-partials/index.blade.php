    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small mb-0">Crie os papéis timbrados que serão usados nos seus documentos em PDF.
                </p>
            </div>
            <a href="{{ route('admin.partials.create') }}" class="btn btn-primary fw-bold shadow-sm">
                ...
                <table class="table table-hover align-middle mb-0" id="partialsTable">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Data de
                                Criação</th>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            $('#partialsTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('admin.partials.index') }}',
                columns: [
