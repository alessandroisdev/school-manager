<x-app-layout>
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="h3 mb-0 text-dark fw-bold">Nova Unidade</h2>
            ...
            <form action="{{ route('admin.units.store') }}" method="POST">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="name" id="name" class="form-control bg-light border-0" placeholder="Ex: Colégio Estadual - Polo Sul" required>
                    </div>
                    
                    <div class="col-md-4">
                        <label for="document" class="form-label fw-bold text-muted small">CNPJ / Documento</label>
                        <input type="text" name="document" id="document" class="form-control bg-light border-0">
                    </div>

                    <div class="col-md-6">
                        <label for="email" class="form-label fw-bold text-muted small">E-mail Institucional</label>
                        <input type="email" name="email" id="email" class="form-control bg-light border-0" placeholder="contato@escola.com">
                    </div>
                ...
                <div class="text-end">
                    <button type="submit" class="btn btn-primary fw-bold shadow-sm px-4">
                        <i class="bi bi-check-lg me-2"></i> Salvar Unidade
                    </button>
                </div>
            </form>
        </div>
