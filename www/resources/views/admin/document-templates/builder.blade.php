<x-app-layout>
    <div class="container-fluid">
        @php
            ...
            $actionUrl = $isEdit ? route('admin.document-templates.update', $documentTemplate) : route('admin.document-templates.store');
        @endphp

        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="h3 mb-1 text-dark fw-bold"><i class="bi bi-magic text-primary"></i> Builder de Documento</h2>
                <p class="text-muted small mb-0">{{ $isEdit ? 'Editando: ' . $documentTemplate->name : 'Criando novo modelo' }}</p>
            </div>
            <a href="{{ route('admin.document-templates.index') }}" class="btn btn-light fw-bold text-secondary">
                    ...
                    <div class="glass-card p-4 mb-4">
                        <div class="row g-3 mb-4">
                            <div class="col-md-8">
                                ...
                                <input type="text" name="name" class="form-control bg-light border-0" value="{{ $documentTemplate->name ?? '' }}" required placeholder="Ex: Contrato Padrão Ensino Médio 2026">
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                <label class="form-label fw-bold text-muted small">Cabeçalho (Papel Timbrado Topo)</label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="content" id="document-editor" class="form-control">{{ $documentTemplate->content ?? '' }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="glass-card p-4 sticky-top" style="top: 100px;">
                        ...
                        <div class="mb-3">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-secondary w-100 mb-2 text-start tag-btn" data-tag="[ALUNO_NOME]">[ALUNO_NOME]</button>
                            <button type="button" class="btn btn-sm btn-outline-secondary w-100 mb-2 text-start tag-btn" data-tag="[ALUNO_CPF]">[ALUNO_CPF]</button>
                            <button type="button" class="btn btn-sm btn-outline-secondary w-100 mb-2 text-start tag-btn" data-tag="[ALUNO_MATRICULA]">[ALUNO_MATRICULA]</button>
                        </div>

                        <div class="mb-3">
                            <span class="d-block text-uppercase fw-bold text-secondary small mb-2">Dados do Responsável</span>
                            <button type="button" class="btn btn-sm btn-outline-secondary w-100 mb-2 text-start tag-btn" data-tag="[RESPONSAVEL_NOME]">[RESPONSAVEL_NOME]</button>
                        </div>

                        <div class="mb-3">
                            <span class="d-block text-uppercase fw-bold text-secondary small mb-2">Dados da Escola / Turma</span>
                            <button type="button" class="btn btn-sm btn-outline-secondary w-100 mb-2 text-start tag-btn" data-tag="[UNIDADE_NOME]">[UNIDADE_NOME]</button>
                            <button type="button" class="btn btn-sm btn-outline-secondary w-100 mb-2 text-start tag-btn" data-tag="[UNIDADE_CNPJ]">[UNIDADE_CNPJ]</button>
                            <button type="button" class="btn btn-sm btn-outline-secondary w-100 mb-2 text-start tag-btn" data-tag="[CURSO_NOME]">[CURSO_NOME]</button>
                        </div>

                        <div class="mb-4">
                            <span class="d-block text-uppercase fw-bold text-secondary small mb-2">Sistema</span>
                            <button type="button" class="btn btn-sm btn-outline-secondary w-100 mb-2 text-start tag-btn" data-tag="[DATA_ATUAL]">[DATA_ATUAL]</button>
                        </div>
