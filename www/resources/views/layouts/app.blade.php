                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex items-center">
                            ...
                            <a href="{{ route('finance.invoices.index') }}" class="{{ request()->routeIs('finance.*') ? 'text-blue-600 border-b-2 border-blue-600 font-medium' : 'text-gray-500 hover:text-gray-700 border-b-2 border-transparent' }} px-1 py-5 text-sm transition-colors">
                                Financeiro (Caixa)
                            </a>
                        </div>
                    </div>
