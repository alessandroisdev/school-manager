<x-app-layout>
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex items-center">
            ...
            <h2 class="text-2xl font-bold text-gray-800">Cadastrar Novo Aluno</h2>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required 
                               class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 px-4 py-2" placeholder="Ex: Chico Bento">
                    ...
                    <div>
                        ...
                        <input type="text" name="document" id="document" value="{{ old('document') }}" required 
                               class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 px-4 py-2" placeholder="000.000.000-00">
